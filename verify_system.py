...
def run_tests():
    ...
    try:
        ...
        profile, paths, plan, eng, quiz = engine.run_learner_pipeline(
            session,
            "I want to prepare for the AZ-204 developer exam.",
            "EMP-001"
        )
        assert_test("Profiler loaded pre-seeded name (Avery Stone)", profile.name == "Avery Stone")
        assert_test("Profiler mapped correct cert AZ-204", profile.certification_target == "AZ-204")
        ...
        new_profile, _, _, _, _ = engine.run_learner_pipeline(
            "new_session",
            "I want to prepare for the AI-102 exam. My name is Alex.",
            "EMP-999"
        )
        assert_test("Profiler mapped fresh user name (Alex)", new_profile.name == "Alex")
        assert_test("Profiler mapped correct cert AI-102 for new user", new_profile.certification_target == "AI-102")
    ...
    try:
        ...
        p1 = LearnerProfile(
            ...
            certification_target="AI-102", practice_score_avg=70, hours_studied=10,
        ...
        p2 = LearnerProfile(
            ...
            certification_target="AI-102", practice_score_avg=85, hours_studied=20,
        ...
        p3 = LearnerProfile(
            ...
            certification_target="AZ-204", practice_score_avg=55, hours_studied=5,
            meeting_hours_per_week=15, focus_hours_per_week=15, preferred_learning_slot="Afternoon"
        )
        
        c_data_ai = engine.fabric_iq.get_certification("AI-102")
        c_data_az = engine.fabric_iq.get_certification("AZ-204")
        ...
        assert_test("Buddy matches have correct target cert", insights.buddy_recommendations[0].certification_target == "AI-102")
    ...
    bad_profile = LearnerProfile(
        ...
        certification_target="AZ-204", practice_score_avg=50, hours_studied=10,
    ...
    bad_quiz = Quiz(
        quiz_id="Q-BAD", learner_id="L-1001", certification_target="AZ-204",
        questions=[
            QuizQuestion(
